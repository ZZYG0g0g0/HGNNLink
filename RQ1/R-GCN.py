...
def main():
    ...
    results_df.to_excel('./new_result/extend_import_IR_results1_weak.xlsx', index=False)
    print("All experiments completed. Results saved to './new_result/extend_import_IR_results1.xlsx'.")
