...
class HAN(nn.Module):
    def __init__(self, in_channels, hidden_channels, metadata):
        ...
        self.fc5 = nn.Linear(64, 1)  # assuming binary classification
...
if __name__ == '__main__':
        ...
        for dataset in datasets:
            ...
            for edge_types in edge_type_combinations:
                ...
                for i in range(50):
                    ...
                    # print(train_data["req","link","code"].edge_label[:100])
    ...
    results_df.to_excel('./new result/extend_import_IR_results_iTrust.xlsx', index=False)
    print("All experiments completed. Results saved to './new_result/extend_import_IR_results_iTrust.xlsx'.")
