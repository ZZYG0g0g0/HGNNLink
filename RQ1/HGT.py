...
#                         print(f"Epoch: {epoch:03d}, Loss: {total_loss / total_examples:.4f}")
    ...
    results_df.to_excel('./new_result/hgt_change.xlsx', index=False)
    print("All experiments completed. Results saved to './new_result/hgt_change.xlsx'.")
